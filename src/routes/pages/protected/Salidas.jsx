...
export const Salidas = () => {
  ...
  const filteredProducts = ordenesBuscadas.filter((order) => {
    ...
    return (
      ...
      order.empleado.toLowerCase().includes(searchTerm.toLowerCase())
    );
  });
  ...
  return (
    <section className="w-full h-full px-5 max-md:px-4 flex flex-col gap-2 py-20 max-md:gap-5">
          ...
          <div>
            ...
            <p>
              ...
              <span className="text-xs text-gray-500 uppercase">
                {" "}
                total final reducido del stock{" "}
        ...
        <article className="flex flex-col gap-4 rounded-xl border border-slate-200 shadow bg-white p-6 max-md:p-3">
          ...
          <div>
            <strong className="block text-sm font-medium text-gray-500 max-md:text-sm uppercase">
              Materiales/categorias Total salidas
            </strong>
      ...
      <div className="mx-6 max-md:mx-2">
        <div className="flex gap-6 max-md:gap-2 items-center max-md:items-start max-md: w-full overflow-x-scroll max-md:items-center ">
          ...
          <div className="flex gap-2 items-center">
            ...
            <button
              ...
              className=" max-md:text-xs bg-white border-slate-300 border-[1px] rounded-xl px-2 py-2 shadow flex gap-3 text-slate-700 hover:shadow-md transtion-all ease-in-out duration-200 max-md:py-1"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
              ...
              >
                <article>
                  <p className="uppercase flex gap-1">
                    <span className="font-semibold text-sm text-slate-700 underline max-md:text-xs">
                      Numero
                    </span>
                    <span className="text-normal max-md:text-xs text-sm text-slate-700">
                      {o.id}
                    </span>
                  </p>
                  <p className="uppercase flex gap-1">
                  ...
                  <p className="uppercase flex gap-1 items-center mt-2">
                    ...
                    <span className="text-normal max-md:text-xs text-sm text-red-700 font-bold bg-red-50 rounded-xl py-1 px-3 border-red-200 border-[1px]">
                      {o.cantidad}
                    </span>
                  </p>
                </article>
